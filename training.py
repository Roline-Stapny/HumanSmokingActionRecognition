...
parser.add_argument('--epochs', default=18, type=int, help='number of total epochs')
...
parser.add_argument('--sampled_data_dir',
                    default=r'/home/roline_stapny/dataset-cropped/dataset/',
                    type=str, help='The dir for the sampled row data')
parser.add_argument('--ucf_list_dir', default=r'/home/roline_stapny/dataset-cropped/dataset/',
...
parser.add_argument('--local_dir',default='/home/roline_stapny/' , help='The local directory of the project, setting where to '
                                                             'save the results of the run') #default=os.getcwd()
