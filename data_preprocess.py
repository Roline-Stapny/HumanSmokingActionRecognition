...
Original file is located at
    https://colab.research.google.com/drive/1qrqt87yZReugMgfjzyqouPw1gE8tpAeA
"""
...
parser.add_argument('--ucf_list_dir', default=r'/content/drive/My Drive/directed studies/test/',
...
parser.add_argument('--checkpoint_path', default='/content/drive/My Drive/directed studies/test/', type=str, help='Optional path to checkpoint model')
...
parser.add_argument('--local_dir',default='/content/drive/My Drive/directed studies/test' , help='The local directory of the project, setting where to '
...
def capture_and_sample_video(row_data_dir, video_name, num_frames_to_extract, sampling_rate, fps, save_path,
    ...
    # t = int(0.2*video_width)
    # b = int(0.8*video_width)  #right

    # # print(t,b)
    # l = int(0.1*video_height) #top
    # r = int(0.8*video_height)
...
dataset_order = ['train', 'val']
datasets = {dataset_order[index]: UCF101Dataset(args.sampled_data_dir, x, mode=dataset_order[index]) for index, x in enumerate([train_data_names, val_data_names])}
...
parser.add_argument('--row_data_dir', default=r'/content/drive/My Drive/directed studies/ucfTrainTestlist/', type=str,
                    help='path to find the UCF101 row data')
parser.add_argument('--ucf_list_dir',
                    default=r'/content/drive/My Drive/directed studies/ucfTrainTestlist/',
                    type=str, help='path to find the UCF101 list splitting the data to train and test')
...
def capture_and_sample_video(row_data_dir, video_name, num_frames_to_extract, sampling_rate, fps, save_path,
    ...
    print("height", video_width,video_height )
...
capture_and_sample_video('/content/drive/My Drive/directed studies/smoke/','A_Beautiful_Mind_2_smoke_u_cm_np1_fr_goo_0.avi', 15, 60, 60, '/content/drive/My Drive/directed studies/test',
                             60, 'main')
...
parser.add_argument('--row_data_dir', default=r'/content/drive/My Drive/directed studies/talk', type=str,
                    help='path to find the UCF101 row data')
parser.add_argument('--ucf_list_dir',
                    default=r'/content/drive/My Drive/directed studies/talk/',
                    type=str, help='path to find the UCF101 list splitting the data to train and test')
...
def main_procesing_data(args, folder_dir, sampled_video_file=None, processing_mode='main'):
    """"
       ...
       """
    if args.dataset == 'UCF101':
        videopath = glob.glob(args.ucf_list_dir+"/*")
...
#os.path.normpath(args.row_data_dir + os.sep + os.pardir)
folder_name = 'talk{}_sampled_data_video_sampling_rate_{}_num frames extracted_{}'.format(args.dataset, args.sampling_rate, args.num_frames_to_extract)
#folder_name = "20-Frames"
folder_dir = os.path.join(global_dir, folder_name)
create_folder_dir_if_needed(folder_dir)
save_setting_info(args, "cpu", folder_dir)
main_procesing_data(args, folder_dir)
